# Extracted from 3DETR utils/pc_util.py (Copyright (c) Facebook, Inc. and its affiliates.)
# Only the two functions the model needs, so we avoid trimesh/plyfile deps.
import torch
